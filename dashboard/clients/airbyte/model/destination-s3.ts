 ...
 */
export interface DestinationS3 {
    /**
     ...
     * @memberof DestinationS3
     */
    's3_bucket_region': DestinationS3S3BucketRegionEnum;
    /**
     * 
     * @type {OutputFormat2}
     * @memberof DestinationS3
     ...
     * @memberof DestinationS3
     */
    'destinationType': DestinationS3DestinationTypeEnum;
}

export const DestinationS3S3BucketRegionEnum = {
    EMPTY: '',
...
export type DestinationS3S3BucketRegionEnum = typeof DestinationS3S3BucketRegionEnum[keyof typeof DestinationS3S3BucketRegionEnum];
export const DestinationS3DestinationTypeEnum = {
    S3: 's3'
} as const;

export type DestinationS3DestinationTypeEnum = typeof DestinationS3DestinationTypeEnum[keyof typeof DestinationS3DestinationTypeEnum];
