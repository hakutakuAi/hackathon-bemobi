 ...
 * 
 * @export
 * @interface DestinationS3GlueUpdate
 */
export interface DestinationS3GlueUpdate {
    /**
     ...
     * @type {string}
     * @memberof DestinationS3GlueUpdate
     */
     ...
     * @memberof DestinationS3GlueUpdate
     */
    's3_bucket_region': DestinationS3GlueUpdateS3BucketRegionEnum;
    /**
     * 
     * @type {OutputFormat1}
     * @memberof DestinationS3GlueUpdate
     ...
     * @memberof DestinationS3GlueUpdate
     */
    'glue_serialization_library': DestinationS3GlueUpdateGlueSerializationLibraryEnum;
}

export const DestinationS3GlueUpdateS3BucketRegionEnum = {
    EMPTY: '',
...
export type DestinationS3GlueUpdateS3BucketRegionEnum = typeof DestinationS3GlueUpdateS3BucketRegionEnum[keyof typeof DestinationS3GlueUpdateS3BucketRegionEnum];
export const DestinationS3GlueUpdateGlueSerializationLibraryEnum = {
...
export type DestinationS3GlueUpdateGlueSerializationLibraryEnum = typeof DestinationS3GlueUpdateGlueSerializationLibraryEnum[keyof typeof DestinationS3GlueUpdateGlueSerializationLibraryEnum];
