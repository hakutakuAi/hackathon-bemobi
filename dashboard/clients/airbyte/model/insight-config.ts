...
export interface InsightConfig {
     ...
     * @memberof InsightConfig
     */
    'level'?: InsightConfigLevelEnum;
    /**
     * A list of chosen fields for fields parameter
     * @type {Array<string>}
     * @memberof InsightConfig
     */
    'fields'?: Array<InsightConfigFieldsEnum>;
    /**
     * A list of chosen breakdowns for breakdowns
     * @type {Array<string>}
     * @memberof InsightConfig
     */
    'breakdowns'?: Array<InsightConfigBreakdownsEnum>;
    /**
     * A list of chosen action_breakdowns for action_breakdowns
     * @type {Array<string>}
     * @memberof InsightConfig
     */
    'action_breakdowns'?: Array<InsightConfigActionBreakdownsEnum>;
    /**
     ...
     * @memberof InsightConfig
     */
    'action_report_time'?: InsightConfigActionReportTimeEnum;
    /**
...
export const InsightConfigLevelEnum = {
    AD: 'ad',
    ADSET: 'adset',
    CAMPAIGN: 'campaign',
    ACCOUNT: 'account'
...
export type InsightConfigLevelEnum = typeof InsightConfigLevelEnum[keyof typeof InsightConfigLevelEnum];
export const InsightConfigFieldsEnum = {
...
export type InsightConfigFieldsEnum = typeof InsightConfigFieldsEnum[keyof typeof InsightConfigFieldsEnum];
export const InsightConfigBreakdownsEnum = {
...
export type InsightConfigBreakdownsEnum = typeof InsightConfigBreakdownsEnum[keyof typeof InsightConfigBreakdownsEnum];
export const InsightConfigActionBreakdownsEnum = {
...
export type InsightConfigActionBreakdownsEnum = typeof InsightConfigActionBreakdownsEnum[keyof typeof InsightConfigActionBreakdownsEnum];
export const InsightConfigActionReportTimeEnum = {
    CONVERSION: 'conversion',
    IMPRESSION: 'impression',
    MIXED: 'mixed'
} as const;

export type InsightConfigActionReportTimeEnum = typeof InsightConfigActionReportTimeEnum[keyof typeof InsightConfigActionReportTimeEnum];
