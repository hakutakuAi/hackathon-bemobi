 ...
 * @export
 * @interface DestinationPgvector
 */
export interface DestinationPgvector {
    /**
     * 
     * @type {Embedding2}
     * @memberof DestinationPgvector
     */
     ...
     * @memberof DestinationPgvector
     */
    'destinationType': DestinationPgvectorDestinationTypeEnum;
}

export const DestinationPgvectorDestinationTypeEnum = {
    PGVECTOR: 'pgvector'
} as const;

export type DestinationPgvectorDestinationTypeEnum = typeof DestinationPgvectorDestinationTypeEnum[keyof typeof DestinationPgvectorDestinationTypeEnum];
