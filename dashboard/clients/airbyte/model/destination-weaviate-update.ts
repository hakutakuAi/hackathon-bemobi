...
// @ts-ignore
import type { Embedding1 } from './embedding1';
// May contain unused imports in some cases
// @ts-ignore
import type { Indexing1 } from './indexing1';
// May contain unused imports in some cases
// @ts-ignore
 ...
 * @export
 * @interface DestinationWeaviateUpdate
 */
export interface DestinationWeaviateUpdate {
    /**
     * 
     * @type {Embedding1}
     * @memberof DestinationWeaviateUpdate
     */
