...
// @ts-ignore
import type { Authentication9 } from './authentication9';

/**
 * 
 * @export
 * @interface SourceZendeskTalkUpdate
 */
export interface SourceZendeskTalkUpdate {
    /**
     ...
     * @type {string}
     * @memberof SourceZendeskTalkUpdate
     */
    'subdomain': string;
    /**
     * 
