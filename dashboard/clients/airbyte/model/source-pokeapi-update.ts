 ...
 * 
 * @export
 * @interface SourcePokeapiUpdate
 */
export interface SourcePokeapiUpdate {
    /**
     * Pokemon requested from the API.
     * @type {string}
     * @memberof SourcePokeapiUpdate
     */
    'pokemon_name': SourcePokeapiUpdatePokemonNameEnum;
}

export const SourcePokeapiUpdatePokemonNameEnum = {
    BULBASAUR: 'bulbasaur',
    IVYSAUR: 'ivysaur',
    VENUSAUR: 'venusaur',
...
export type SourcePokeapiUpdatePokemonNameEnum = typeof SourcePokeapiUpdatePokemonNameEnum[keyof typeof SourcePokeapiUpdatePokemonNameEnum];
