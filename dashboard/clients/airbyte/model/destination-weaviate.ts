 ...
 * @export
 * @interface DestinationWeaviate
 */
export interface DestinationWeaviate {
    /**
     * 
     * @type {Embedding}
     * @memberof DestinationWeaviate
     */
    'embedding': Embedding;
    /**
     * 
     ...
     * @memberof DestinationWeaviate
     */
    'destinationType': DestinationWeaviateDestinationTypeEnum;
}

export const DestinationWeaviateDestinationTypeEnum = {
    WEAVIATE: 'weaviate'
} as const;

export type DestinationWeaviateDestinationTypeEnum = typeof DestinationWeaviateDestinationTypeEnum[keyof typeof DestinationWeaviateDestinationTypeEnum];
