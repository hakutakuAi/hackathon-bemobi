...
// @ts-ignore
import type { AuthenticationMode1 } from './authentication-mode1';
// May contain unused imports in some cases
// @ts-ignore
 ...
 * 
 * @export
 * @interface DestinationAwsDatalakeUpdate
 */
export interface DestinationAwsDatalakeUpdate {
    /**
     * target aws account id
     * @type {string}
     * @memberof DestinationAwsDatalakeUpdate
     */
     ...
     * @memberof DestinationAwsDatalakeUpdate
     */
    'credentials': AuthenticationMode1;
    /**
     * The region of the S3 bucket. See <a href=\"https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-available-regions\">here</a> for all region codes.
     * @type {string}
     * @memberof DestinationAwsDatalakeUpdate
     */
    'region': DestinationAwsDatalakeUpdateRegionEnum;
    /**
     ...
     * @memberof DestinationAwsDatalakeUpdate
     */
    'partitioning'?: DestinationAwsDatalakeUpdatePartitioningEnum;
    /**
...
export const DestinationAwsDatalakeUpdateRegionEnum = {
    EMPTY: '',
...
export type DestinationAwsDatalakeUpdateRegionEnum = typeof DestinationAwsDatalakeUpdateRegionEnum[keyof typeof DestinationAwsDatalakeUpdateRegionEnum];
export const DestinationAwsDatalakeUpdatePartitioningEnum = {
...
export type DestinationAwsDatalakeUpdatePartitioningEnum = typeof DestinationAwsDatalakeUpdatePartitioningEnum[keyof typeof DestinationAwsDatalakeUpdatePartitioningEnum];
