...
export interface OAuth2025 {
     ...
     * @memberof OAuth2025
     */
    'credentials'?: OAuth2025CredentialsEnum;
    /**
...
export const OAuth2025CredentialsEnum = {
    OAUTH2_0: 'oauth2.0'
} as const;

export type OAuth2025CredentialsEnum = typeof OAuth2025CredentialsEnum[keyof typeof OAuth2025CredentialsEnum];
