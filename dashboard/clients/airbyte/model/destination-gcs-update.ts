...
// @ts-ignore
import type { Authentication35 } from './authentication35';
// May contain unused imports in some cases
// @ts-ignore
 ...
 * 
 * @export
 * @interface DestinationGcsUpdate
 */
export interface DestinationGcsUpdate {
    /**
     ...
     * @memberof DestinationGcsUpdate
     */
    'gcs_bucket_region'?: DestinationGcsUpdateGcsBucketRegionEnum;
    /**
     * 
     * @type {Authentication35}
     * @memberof DestinationGcsUpdate
     */
    'credential': Authentication35;
    /**
     * 
     * @type {OutputFormat}
     * @memberof DestinationGcsUpdate
...
export const DestinationGcsUpdateGcsBucketRegionEnum = {
...
export type DestinationGcsUpdateGcsBucketRegionEnum = typeof DestinationGcsUpdateGcsBucketRegionEnum[keyof typeof DestinationGcsUpdateGcsBucketRegionEnum];
