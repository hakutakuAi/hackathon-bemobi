...
// May contain unused imports in some cases
// @ts-ignore
import type { Indexing2 } from './indexing2';
// May contain unused imports in some cases
// @ts-ignore
 ...
 * @export
 * @interface DestinationQdrant
 */
export interface DestinationQdrant {
    /**
     * 
     * @type {Embedding2}
     * @memberof DestinationQdrant
     */
     ...
     * @memberof DestinationQdrant
     */
    'destinationType': DestinationQdrantDestinationTypeEnum;
}

export const DestinationQdrantDestinationTypeEnum = {
    QDRANT: 'qdrant'
} as const;

export type DestinationQdrantDestinationTypeEnum = typeof DestinationQdrantDestinationTypeEnum[keyof typeof DestinationQdrantDestinationTypeEnum];
