...
export interface SourceOrb {
     ...
     * @memberof SourceOrb
     */
    'sourceType': SourceOrbSourceTypeEnum;
}

export const SourceOrbSourceTypeEnum = {
    ORB: 'orb'
} as const;

export type SourceOrbSourceTypeEnum = typeof SourceOrbSourceTypeEnum[keyof typeof SourceOrbSourceTypeEnum];
