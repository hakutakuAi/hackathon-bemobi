 ...
 * @export
 * @interface ServiceKeyAuthentication1
 */
export interface ServiceKeyAuthentication1 {
    /**
     * 
     * @type {string}
     * @memberof ServiceKeyAuthentication1
     */
    'auth_type'?: ServiceKeyAuthentication1AuthTypeEnum;
    /**
...
export const ServiceKeyAuthentication1AuthTypeEnum = {
    SERVICE: 'Service'
} as const;

export type ServiceKeyAuthentication1AuthTypeEnum = typeof ServiceKeyAuthentication1AuthTypeEnum[keyof typeof ServiceKeyAuthentication1AuthTypeEnum];
