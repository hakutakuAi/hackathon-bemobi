...
// @ts-ignore
import type { LoadingMethod3 } from './loading-method3';

/**
 * 
 * @export
 * @interface DestinationBigqueryUpdate
 */
export interface DestinationBigqueryUpdate {
    /**
     ...
     * @type {string}
     * @memberof DestinationBigqueryUpdate
     */
    'project_id': string;
    /**
     ...
     * @memberof DestinationBigqueryUpdate
     */
    'dataset_location': DestinationBigqueryUpdateDatasetLocationEnum;
    /**
     ...
     * @memberof DestinationBigqueryUpdate
     */
    'transformation_priority'?: DestinationBigqueryUpdateTransformationPriorityEnum;
    /**
...
export const DestinationBigqueryUpdateDatasetLocationEnum = {
    US: 'US',
    EU: 'EU',
...
export type DestinationBigqueryUpdateDatasetLocationEnum = typeof DestinationBigqueryUpdateDatasetLocationEnum[keyof typeof DestinationBigqueryUpdateDatasetLocationEnum];
export const DestinationBigqueryUpdateTransformationPriorityEnum = {
    INTERACTIVE: 'interactive',
    BATCH: 'batch'
} as const;

export type DestinationBigqueryUpdateTransformationPriorityEnum = typeof DestinationBigqueryUpdateTransformationPriorityEnum[keyof typeof DestinationBigqueryUpdateTransformationPriorityEnum];
