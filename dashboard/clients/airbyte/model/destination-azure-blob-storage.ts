 ...
 * 
 * @export
 * @interface DestinationAzureBlobStorage
 */
export interface DestinationAzureBlobStorage {
    /**
     * This is Azure Blob Storage endpoint domain name. Leave default value (or leave it empty if run container from command line) to use Microsoft native from example.
     * @type {string}
     * @memberof DestinationAzureBlobStorage
     */
     ...
     * @memberof DestinationAzureBlobStorage
     */
    'destinationType': DestinationAzureBlobStorageDestinationTypeEnum;
}

export const DestinationAzureBlobStorageDestinationTypeEnum = {
    AZURE_BLOB_STORAGE: 'azure-blob-storage'
} as const;

export type DestinationAzureBlobStorageDestinationTypeEnum = typeof DestinationAzureBlobStorageDestinationTypeEnum[keyof typeof DestinationAzureBlobStorageDestinationTypeEnum];
