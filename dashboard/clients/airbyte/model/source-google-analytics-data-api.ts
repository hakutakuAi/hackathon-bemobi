...
// @ts-ignore
import type { Credentials2 } from './credentials2';
// May contain unused imports in some cases
// @ts-ignore
 ...
 * 
 * @export
 * @interface SourceGoogleAnalyticsDataApi
 */
export interface SourceGoogleAnalyticsDataApi {
    /**
     * 
     * @type {Credentials2}
     * @memberof SourceGoogleAnalyticsDataApi
     */
     ...
     * @memberof SourceGoogleAnalyticsDataApi
     */
    'sourceType': SourceGoogleAnalyticsDataApiSourceTypeEnum;
}

export const SourceGoogleAnalyticsDataApiSourceTypeEnum = {
    GOOGLE_ANALYTICS_DATA_API: 'google-analytics-data-api'
} as const;

export type SourceGoogleAnalyticsDataApiSourceTypeEnum = typeof SourceGoogleAnalyticsDataApiSourceTypeEnum[keyof typeof SourceGoogleAnalyticsDataApiSourceTypeEnum];
