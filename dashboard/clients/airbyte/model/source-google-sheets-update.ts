...
// @ts-ignore
import type { Authentication7 } from './authentication7';

/**
 * 
 * @export
 * @interface SourceGoogleSheetsUpdate
 */
export interface SourceGoogleSheetsUpdate {
    /**
     ...
     * @type {number}
     * @memberof SourceGoogleSheetsUpdate
     */
    'batch_size'?: number;
    /**
