...
export interface S3 {
     ...
     * @memberof S3
     */
    'storage_type': S3StorageTypeEnum;
    /**
     ...
     * @memberof S3
     */
    's3_bucket_region'?: S3S3BucketRegionEnum;
    /**
...
export const S3S3BucketRegionEnum = {
    EMPTY: '',
...
export type S3S3BucketRegionEnum = typeof S3S3BucketRegionEnum[keyof typeof S3S3BucketRegionEnum];
