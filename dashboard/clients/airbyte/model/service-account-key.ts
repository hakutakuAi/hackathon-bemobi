...
export interface ServiceAccountKey {
     ...
     * @type {string}
     * @memberof ServiceAccountKey
     */
    'credentials_title'?: ServiceAccountKeyCredentialsTitleEnum;
    /**
...
export const ServiceAccountKeyCredentialsTitleEnum = {
    SERVICE_ACCOUNTS: 'Service accounts'
} as const;

export type ServiceAccountKeyCredentialsTitleEnum = typeof ServiceAccountKeyCredentialsTitleEnum[keyof typeof ServiceAccountKeyCredentialsTitleEnum];
