...
export interface SourceStripe {
     ...
     * @memberof SourceStripe
     */
    'sourceType': SourceStripeSourceTypeEnum;
}

export const SourceStripeSourceTypeEnum = {
    STRIPE: 'stripe'
} as const;

export type SourceStripeSourceTypeEnum = typeof SourceStripeSourceTypeEnum[keyof typeof SourceStripeSourceTypeEnum];
