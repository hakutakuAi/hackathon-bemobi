 ...
 * 
 * @export
 * @interface CustomReportConfig2
 */
export interface CustomReportConfig2 {
    /**
     * The name of the custom report, this name would be used as stream name
     * @type {string}
     * @memberof CustomReportConfig2
     */
    'name': string;
    /**
     ...
     * @memberof CustomReportConfig2
     */
    'reporting_object': CustomReportConfig2ReportingObjectEnum;
    /**
...
export const CustomReportConfig2ReportingObjectEnum = {
...
export type CustomReportConfig2ReportingObjectEnum = typeof CustomReportConfig2ReportingObjectEnum[keyof typeof CustomReportConfig2ReportingObjectEnum];
