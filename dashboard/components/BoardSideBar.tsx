...
const AsideMenu: React.FC = () => (
	<aside className="flex">
		<div className="flex h-screen w-12 flex-col items-center space-y-8 border-r border-[#B24128] bg-none py-8 dark:border-slate-700 dark:bg-slate-900 sm:w-16">
			<a href="/Chat" className="rounded-lg p-1.5 text-slate-500 transition-colors duration-200 hover:bg-slate-200 focus:outline-none dark:text-slate-400 dark:hover:bg-slate-800">
